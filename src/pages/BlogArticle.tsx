            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto">
                ...
                <div className="prose prose-lg max-w-none 
                  ...
                  prose-h1:text-3xl prose-h1:md:text-4xl prose-h1:mt-0 prose-h1:mb-8 prose-h1:leading-tight prose-h1:text-center
                  prose-h2:text-2xl prose-h2:md:text-3xl prose-h2:mt-12 prose-h2:mb-6 prose-h2:leading-tight prose-h2:text-left prose-h2:border-b prose-h2:border-border/30 prose-h2:pb-3
                  prose-h3:text-xl prose-h3:md:text-2xl prose-h3:mt-8 prose-h3:mb-4 prose-h3:leading-snug prose-h3:text-left prose-h3:text-secondary
                  prose-p:text-muted-foreground prose-p:text-base prose-p:md:text-lg prose-p:leading-relaxed prose-p:mb-6 prose-p:text-justify
                  prose-strong:text-foreground prose-strong:font-semibold
                  prose-li:text-muted-foreground prose-li:text-base prose-li:md:text-lg prose-li:leading-relaxed prose-li:mb-3
